  ...
  return (
    <section className="hero-gradient min-h-[80vh] flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-50">
        ...
        <div className="absolute top-40 right-20 w-24 h-24 bg-accent-orange/5 rounded-full floating" style={{ animationDelay: '1s' }}></div>
        <div className="absolute bottom-32 left-1/4 w-40 h-40 bg-primary/5 rounded-full floating" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
            ...
            <div className="relative">
              <div className="handwritten text-lg text-muted-foreground transform rotate-2">
                <svg 
                  ...
                  stroke="currentColor"
                >
                  <path d="M8 24C16 8 32 8 48 16C52 18 56 20 60 16" strokeWidth="2" strokeLinecap="round"/>
                </svg>
                US$ 24.90 / month
              </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
          <Button 
            className="btn-primary px-8 py-3 text-lg rounded-lg font-medium min-w-[200px]"
          >
            Start now - It's free
          </Button>
        ...
        <div className="inline-flex items-center bg-card border border-border rounded-xl px-6 py-4 shadow-soft">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm text-muted-foreground">
              eCommerce & Website Academy - San Francisco, CA
            </span>
