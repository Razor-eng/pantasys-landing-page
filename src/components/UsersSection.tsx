  ...
  return (
    <section className="py-20 bg-muted/30 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30">
        ...
        <div className="absolute top-40 right-20 w-16 h-16 bg-accent-orange/10 rounded-full"></div>
        <div className="absolute bottom-20 left-1/4 w-24 h-24 bg-primary/10 rounded-full"></div>
        <div className="absolute bottom-40 right-1/3 w-12 h-12 bg-accent-orange/10 rounded-full"></div>
      </div>
      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="relative mb-12">
            ...
            <div className="absolute -bottom-8 -right-8 w-12 h-12 bg-accent-orange/20 rounded-full floating" style={{ animationDelay: '1s' }}></div>
          </div>
          ...
          <div className="space-y-8">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Companies of all sizes trust Odoo to manage their business operations. 
              From startups to enterprises, join millions of satisfied users worldwide.
            </p>

            {/* Stats */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-primary mb-2">15M+</div>
                <div className="text-muted-foreground">Active Users</div>
              </div>
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-primary mb-2">190+</div>
            ...
            <div className="bg-card rounded-2xl p-8 shadow-soft mt-12 max-w-2xl mx-auto">
              <div className="text-lg text-muted-foreground italic mb-4">
                "Odoo transformed our business operations. We went from using 5 different tools 
                to just one platform that does everything we need."
              </div>
